...
class MySyncConsumer(SyncConsumer):
    ...
    def websocket_receive(self, event):
        ...
        if self.scope['user'].is_authenticated:
            ...
            # Send message to the group. By this action data is not visible in website, to show data in
            ...
            # Send msg to client after converting python dict into string
            self.send({
                'type': 'websocket.send',
    ...
    def websocket_receive(self, event):
        ...
        if self.scope['user'].is_authenticated:
            ...
            chat.save()
            '''Add another key (user) to python dict (data) for showing 
            user name in frontend  '''
            data['user'] = self.scope['user'].username
            print('Complete Data.....', data)
            # It is a python dict, it wil have to convert into string to sens it to group
            print('Type of Complete Data.....', type(data))

            '''Send message to the group. By this action data is not 
            visible in website, to show data in frontend server must send 
            data to client as done in the chat_message method/handler, 
            and client must send it to textarea.'''
...
class MyAsyncConsumer(AsyncConsumer):
    ...
    async def websocket_receive(self, event):
        ...
        if self.scope['user'].is_authenticated:
            ...
            await database_sync_to_async(chat.save)()
            # Add another key (user) to python dict (data) 
            data['user'] = self.scope['user'].username
            print('Complete Data.....', data)
            # It is a python dict, it wil have to convert into string to sens it to group
            print('Type of Complete Data.....', type(data))
